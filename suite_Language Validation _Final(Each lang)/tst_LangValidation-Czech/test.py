...
Settings='Nastavení'
Recording='Nahrávání'
PrimaryusedID='ID pacienta'
BTLworkflow='Náběr - vyhodnocení'
...
# Step2 : Set Language in settings and verify whether set language is applied in device        
        step2=selectLanguageinSettingsandVerifyWorkaroundmethod(czechlanID,Settings,Recording,PrimaryusedIDPID,BTLworkflowRecordandevaluavteID)
        snooze(2)
