...
PrimaryusedID='ID Paziente'
BTLworkflow='Registrare - Valutare'
...
# Step2 : Set Language in settings and verify whether set language is applied in device        
        step2=selectLanguageinSettingsandVerifyWorkaroundmethod(ItalainlnagID,Settings,Recording,PrimaryusedIDPID,BTLworkflowRecordandevaluavteID)
        snooze(2)
