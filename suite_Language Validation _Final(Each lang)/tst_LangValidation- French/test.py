...
PrimaryusedID='ID Patient'
BTLworkflow='Enregistrer - Évaluer'
...
# Step2 : Set Language in settings and verify whether set language is applied in device        
        step2=selectLanguageinSettingsandVerifyWorkaroundmethod(FrenchLangID,Settings,Recording,PrimaryusedIDPID,BTLworkflowRecordandevaluavteID)
        snooze(2)
