...
Language='Русский'
Settings='Настройки'
Recording='Запись ЭКГ'
PrimaryusedID='PID (ID пациента)'
BTLworkflow='Запись - Анализ'
...
# Step2 : Set Language in settings and verify whether set language is applied in device        
        step2=selectLanguageinSettingsandVerifyWorkaroundmethod(RussianlangID,Settings,Recording,PrimaryusedIDPID,BTLworkflowRecordandevaluavteID)
        snooze(2)
