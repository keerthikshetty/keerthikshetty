...
Recording='Felvétel'
PrimaryusedID='Páciens azonosító'
BTLworkflow='Felvétel - Kiértékelés'
...
# Step2 : Set Language in settings and verify whether set language is applied in device        
        step2=selectLanguageinSettingsandVerifyWorkaroundmethod(HungerianID,Settings,Recording,PrimaryusedIDPID,BTLworkflowRecordandevaluavteID)
        snooze(2)
