...
Settings='Ustawienia'
Recording='Zapis EKG'
PrimaryusedID='ID pacjenta'
BTLworkflow='Zapisz - Oceń'
...
# Step2 : Set Language in settings and verify whether set language is applied in device        
        step2=selectLanguageinSettingsandVerifyWorkaroundmethod(PolishLangID,Settings,Recording,PrimaryusedIDPID,BTLworkflowRecordandevaluavteID)
        snooze(2)
