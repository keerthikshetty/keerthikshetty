...
Settings='Settings'
Recording='Recording'
PrimaryusedID='Patient ID'
BTLworkflow='Record - Evaluate'
...
# Step2 : Set Language in settings and verify whether set language is applied in device        
        step2=selectLanguageinSettingsandVerifyWorkaroundmethod(EnglishlangID,Settings,Recording,PrimaryusedIDPID,BTLworkflowRecordandevaluavteID)
        snooze(2)
