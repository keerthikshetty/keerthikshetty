...
Settings='Ayarlar'
Recording='Kayıt'
PrimaryusedID='Hasta ID'
BTLworkflow='Kaydet - Değerlendir'
...
# Step2 : Set Language in settings and verify whether set language is applied in device        
        step2=selectLanguageinSettingsandVerifyWorkaroundmethod(TurkishLangID,Settings,Recording,PrimaryusedIDPID,BTLworkflowRecordandevaluavteID)
        snooze(2)
