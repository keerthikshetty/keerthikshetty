...
Settings='Postavke'
Recording='Snimanje'
PrimaryusedID='ID pacijenta'
BTLworkflow='Snimanje - Rezultat'
...
# Step2 : Set Language in settings and verify whether set language is applied in device        
        step2=selectLanguageinSettingsandVerifyWorkaroundmethod(CrotianLangID,Settings,Recording,PrimaryusedIDPID,BTLworkflowRecordandevaluavteID)
        snooze(2)
